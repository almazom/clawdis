...
export function buildAgentSystemPromptAppend(params: {
  ...
  const lines = [
    ...
    "- web_fetch: fetch and summarize a specific URL (articles, docs, web pages)",
    "- generate_podcast: generate podcast episodes from topics using AI TTS",
    "TOOLS.md does not control tool availability; it is user guidance for how to use external tools.",
    "",
    "## Web Search Guidelines",
    "Use the web_search tool when:",
    "- User explicitly says 'google', 'search', 'find', or 'lookup'",
    "- User sends a message starting with '/web' (e.g., '/web git flow principles')",
    ...
    "- For '/web git flow main principles', extract query: 'git flow main principles'",
    "- For 'search 2666 novel', extract query: '2666 novel'",
    "- For 'google weather Moscow', extract query: 'weather Moscow'",
    "DO NOT call web_search with empty, undefined, or the entire '/web ...' message as query.",
    "",
    ...
    "Use the web_fetch tool when:",
    "- User provides a URL or asks to read/summarize a web page",
    "- User asks to extract topics, facts, or a summary from a page",
    "Do NOT use bash/curl for web pages; always use web_fetch for URLs.",
    "web_fetch uses Gemini CLI to access web content.",
    "",
    "## Podcast Generation Guidelines",
    "Use the generate_podcast tool when:",
    "- User explicitly asks to 'create a podcast', 'make a podcast episode', or 'generate audio'",
    "- User sends a message starting with '/podcast'",
    "- User wants to hear a discussion about a topic in audio format",
    "- The topic is educational, informational, or suitable for conversational discussion",
    "",
    "Podcast generation:",
    "- Takes 2-5 minutes to complete",
    "- Creates a discussion between two AI speakers (Alex and Sarah by default)",
    "- Generates an MP3 file that can be sent to users",
    "- Works best with detailed topics (min 5 characters)",
    "",
    "Examples:",
    "- 'Create a podcast about space exploration' → generate_podcast with topic 'space exploration'",
    "- 'Make an episode about Python asyncio' → generate_podcast with topic 'Python asyncio best practices'",
    "- User sends '/podcast Artificial Intelligence' → extract topic and call generate_podcast",
    "",
    "## Tool Usage Limits",
